...
public class EmployeeV2ControllerTest {
    ...
    @Test
    public void test_createEmployee_WithoutFirstName() throws Exception {
    ...
    @Test
    public void test_createEmployee_WithoutLastName() throws Exception {
    ...
    @Test
    public void test_createEmployee_WithoutOrganization() throws Exception {
    ...
    @Test
    public void test_createEmployee_EmptyFirstName() throws Exception {
    ...
    @Test
    public void test_createEmployee_EmptyLastName() throws Exception {
    ...
    public void test_getEmployeeById_ValidId() throws Exception {
        ...
        this.mockMvc.perform(
                        get("/v2/employees/{id}", first.getId()))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    public void test_updateEmployee_Valid() throws Exception {
        ...
        final MockHttpServletResponse response = this.mockMvc.perform(
                        put("/v2/employees/{id}", first.getId())
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(new Gson().toJson(employee)))
                .andDo(print())
    ...
    @Test
    public void test_updateEmployee_WithoutFirstName() throws Exception {
    ...
    @Test
    public void test_updateEmployee_WithoutLastName() throws Exception {
    ...
    @Test
    public void test_updateEmployee_EmptyFirstName() throws Exception {
    ...
    @Test
    public void test_updateEmployee_EmptyLastName() throws Exception {
    ...
    public void test_deleteEmployee_Valid() throws Exception {
        ...
        final MockHttpServletResponse response = this.mockMvc.perform(
                        delete("/v2/employees/{id}", first.getId()))
                .andDo(print())
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
